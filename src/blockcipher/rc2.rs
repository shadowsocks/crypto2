...
fn test_rc2() {
    ...
    assert_eq!(
        &ciphertext[..],
        &hex::decode("ebb773f993278eff").unwrap()[..]
    );
    ...
    assert_eq!(
        &ciphertext[..],
        &hex::decode("278b27e42e2f0d49").unwrap()[..]
    );
    ...
    assert_eq!(
        &ciphertext[..],
        &hex::decode("30649edf9be7d2c2").unwrap()[..]
    );
    ...
    assert_eq!(
        &ciphertext[..],
        &hex::decode("61a8a244adacccf0").unwrap()[..]
    );
    ...
    assert_eq!(
        &ciphertext[..],
        &hex::decode("6ccf4308974c267f").unwrap()[..]
    );
    ...
    assert_eq!(
        &ciphertext[..],
        &hex::decode("1a807d272bbe5db1").unwrap()[..]
    );
    ...
    assert_eq!(
        &ciphertext[..],
        &hex::decode("2269552ab0f85ca6").unwrap()[..]
    );

    let key = hex::decode(
        "88bca90e90875a7f0f79c384627bafb216f80a6f85920584\
c42fceb0be255daf1e",
    )
    .unwrap();
    ...
    assert_eq!(
        &ciphertext[..],
        &hex::decode("5b78d3a43dfff1f1").unwrap()[..]
    );
}
