...
pub unsafe fn transform(state: &mut [__m256i; 4], block: &[u8], counter: u128, flags: u128) {
    ...
    vd = _mm256_xor_si256(vd, _mm256_setr_epi64x(t0 as i64, t1 as i64, f0 as i64, f1 as i64));
    ...
    // 12 Rounds
    ROUND!(va, vb, vc, vd, m[ 0], m[ 2], m[ 4], m[ 6],   m[ 8], m[10], m[12], m[14],   m[ 1], m[ 3], m[ 5], m[ 7],   m[ 9], m[11], m[13], m[15]);
    ROUND!(va, vb, vc, vd, m[14], m[ 4], m[ 9], m[13],   m[ 1], m[ 0], m[11], m[ 5],   m[10], m[ 8], m[15], m[ 6],   m[12], m[ 2], m[ 7], m[ 3]);
    ROUND!(va, vb, vc, vd, m[11], m[12], m[ 5], m[15],   m[10], m[ 3], m[ 7], m[ 9],   m[ 8], m[ 0], m[ 2], m[13],   m[14], m[ 6], m[ 1], m[ 4]);
    ROUND!(va, vb, vc, vd, m[ 7], m[ 3], m[13], m[11],   m[ 2], m[ 5], m[ 4], m[15],   m[ 9], m[ 1], m[12], m[14],   m[ 6], m[10], m[ 0], m[ 8]);
    ROUND!(va, vb, vc, vd, m[ 9], m[ 5], m[ 2], m[10],   m[14], m[11], m[ 6], m[ 3],   m[ 0], m[ 7], m[ 4], m[15],   m[ 1], m[12], m[ 8], m[13]);
    ROUND!(va, vb, vc, vd, m[ 2], m[ 6], m[ 0], m[ 8],   m[ 4], m[ 7], m[15], m[ 1],   m[12], m[10], m[11], m[ 3],   m[13], m[ 5], m[14], m[ 9]);
    ROUND!(va, vb, vc, vd, m[12], m[ 1], m[14], m[ 4],   m[ 0], m[ 6], m[ 9], m[ 8],   m[ 5], m[15], m[13], m[10],   m[ 7], m[ 3], m[ 2], m[11]);
    ROUND!(va, vb, vc, vd, m[13], m[ 7], m[12], m[ 3],   m[ 5], m[15], m[ 8], m[ 2],   m[11], m[14], m[ 1], m[ 9],   m[ 0], m[ 4], m[ 6], m[10]);
    ROUND!(va, vb, vc, vd, m[ 6], m[14], m[11], m[ 0],   m[12], m[13], m[ 1], m[10],   m[15], m[ 9], m[ 3], m[ 8],   m[ 2], m[ 7], m[ 4], m[ 5]);
    ROUND!(va, vb, vc, vd, m[10], m[ 8], m[ 7], m[ 1],   m[15], m[ 9], m[ 3], m[13],   m[ 2], m[ 4], m[ 6], m[ 5],   m[11], m[14], m[12], m[ 0]);
...
pub unsafe fn transform(state: &mut [__m256i; 4], block: &[u8], counter: u128, flags: u128) {
    ...
    let m7 = _mm256_broadcastsi128_si256(_mm_loadu_si128(block.as_ptr().add(112) as *const __m128i));
