...
// IV XOR ParamBlock
const BLAKE2S_224_IV: [u32; 8] = [
    0x6b08e67b, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19,
];
// IV XOR ParamBlock
...
impl Blake2s224 {
    ...
    pub fn new() -> Self {
        Self {
            inner: Blake2s::new(BLAKE2S_224_IV, b""),
        }
    }
...
impl Blake2s256 {
    ...
    pub fn new() -> Self {
        Self {
            inner: Blake2s::new(BLAKE2S_256_IV, b""),
        }
    }
...
fn test_blake2s() {
    ...
    assert_eq!(
        &blake2s_224(b""),
        &hex::decode(
            "1fa1291e65248b37b3433475b2a0dd63\
                          d54a11ecc4e3e034e7bc1ef4"
        )
        .unwrap()[..]
    );
    assert_eq!(
