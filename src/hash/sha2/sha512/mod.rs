...
fn test_sha512_one_block_message() {
    let msg = b"abc";
    let digest = [
        221u8, 175, 53, 161, 147, 97, 122, 186, 204, 65, 115, 73, 174, 32, 65, 49, 18, 230, 250,
        78, 137, 169, 126, 162, 10, 158, 238, 230, 75, 85, 211, 154, 33, 146, 153, 42, 39, 79, 193,
...
fn test_sha512_multi_block_message() {
    ...
    let digest = [
        32u8, 74, 143, 198, 221, 168, 47, 10, 12, 237, 123, 235, 142, 8, 164, 22, 87, 193, 110,
        244, 104, 178, 40, 168, 39, 155, 227, 49, 167, 3, 195, 53, 150, 253, 21, 193, 59, 27, 7,
        249, 170, 29, 59, 234, 87, 120, 156, 160, 49, 173, 133, 199, 167, 29, 215, 3, 84, 236, 99,
        18, 56, 202, 52, 69,
    ];
    assert_eq!(&(sha512(&msg[..]))[..], &digest[..]);
}
...
fn test_sha512_long_message() {
    ...
    let digest = [
        231u8, 24, 72, 61, 12, 231, 105, 100, 78, 46, 66, 199, 188, 21, 180, 99, 142, 31, 152, 177,
        59, 32, 68, 40, 86, 50, 168, 3, 175, 169, 115, 235, 222, 15, 242, 68, 135, 126, 166, 10,
        76, 176, 67, 44, 229, 119, 195, 27, 235, 0, 156, 92, 44, 73, 170, 46, 78, 173, 178, 23,
        173, 140, 192, 155,
    ];
    assert_eq!(&(sha512(&msg[..]))[..], &digest[..]);
}
...
fn test_sha384_one_block_message() {
    let msg = b"abc";
    let digest = [
        203, 0, 117, 63, 69, 163, 94, 139, 181, 160, 61, 105, 154, 198, 80, 7, 39, 44, 50, 171, 14,
        222, 209, 99, 26, 139, 96, 90, 67, 255, 91, 237, 128, 134, 7, 43, 161, 231, 204, 35, 88,
        186, 236, 161, 52, 200, 37, 167,
    ];
...
fn test_sha384_multi_block_message() {
    let msg = b"abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq";
    let digest = [
        51, 145, 253, 221, 252, 141, 199, 57, 55, 7, 166, 91, 27, 71, 9, 57, 124, 248, 177, 209,
        98, 175, 5, 171, 254, 143, 69, 13, 229, 243, 107, 198, 176, 69, 90, 133, 32, 188, 78, 111,
        95, 233, 91, 31, 227, 200, 69, 43,
    ];
    assert_eq!(&(sha384(&msg[..]))[..], &digest[..]);
}
#[test]
fn test_sha384_long_message() {
    let msg = vec![b'a'; 1000_000];
    let digest = [
        157, 14, 24, 9, 113, 100, 116, 203, 8, 110, 131, 78, 49, 10, 74, 28, 237, 20, 158, 156, 0,
        242, 72, 82, 121, 114, 206, 197, 112, 76, 42, 91, 7, 184, 179, 220, 56, 236, 196, 235, 174,
        151, 221, 216, 127, 61, 137, 133,
    ];
    assert_eq!(&(sha384(&msg[..]))[..], &digest[..]);
}
