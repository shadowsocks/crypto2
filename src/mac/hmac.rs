...
fn test_hmac_sha1() {
    ...
    assert_eq!(&hex::encode_lowercase(&HmacSha1::oneshot(key, data)), result);
}
...
fn test_hmac_sha2_256() {
    ...
    assert_eq!(&hex::encode_lowercase(&HmacSha256::oneshot(key, data)), result);
}
#[test]
fn test_hmac_sha2_384() {
    ...
    assert_eq!(&hex::encode_lowercase(&HmacSha384::oneshot(key, data)), result);
}
#[test]
fn test_hmac_sha2_512() {
    ...
    assert_eq!(&hex::encode_lowercase(&HmacSha512::oneshot(key, data)), result);
}