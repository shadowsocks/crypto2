...
impl Polyval {
    ...
    fn gf_mul(&mut self) {
        ...
        let a = [
            ...
            u64::from_le_bytes([
                self.h[8], self.h[9], self.h[10], self.h[11], self.h[12], self.h[13], self.h[14],
                self.h[15],
            ]),
        ];
        ...
        unsafe {
            let tmp33: &mut [u32; 4] =
                core::mem::transmute::<&mut [u64; 2], &mut [u32; 4]>(&mut tmp3);
            let tmp11: &mut [u32; 4] =
                core::mem::transmute::<&mut [u64; 2], &mut [u32; 4]>(&mut tmp1);
